...
class contact_info {
	...
	function contact_info_save_data(){
		if(isset($_POST) && sanitize_text_field($_POST['update_contact']) == "update_contact"){
			$cph = sanitize_text_field($_POST['cph']);
			$cmail = sanitize_text_field($_POST['cmail']);
			$cadd = esc_html($_POST['cadd']);
	...
	function contact_info_afo_plugin_menu () {
		add_options_page('Contact Info', 'Contact Info', 'manage_options', 'created_by_AFO',  array( $this, 'contact_info_options' ) );
	}
	...
	<table width="99%" border="0" style="background-color:#ffffff; border:1px solid #ccc; margin-top:10px; padding:10px;">
	<form id="form1" name="form1" method="post" action="">
	  ...
	  <tr>
		<td colspan="2" align="left"><div id="utxt" onclick="Usage()" class="button"><strong>Show Usage</strong></div></td>
	  </tr> 
	  <tr>
